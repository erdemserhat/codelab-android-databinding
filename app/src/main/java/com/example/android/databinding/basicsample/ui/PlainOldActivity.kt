...
import com.example.android.databinding.basicsample.util.getAssociatedColor
...
class PlainOldActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
         ...
         * You'll need it to set those layout variables you declared in the <data> block.
         * Binding classes are generated automatically by the library.
         */
        val binding : PlainActivityBinding =
            DataBindingUtil.setContentView(this, R.layout.plain_activity)

        //val color = getAssociatedColor(viewModel.popularity.value!!, context = applicationContext)

        //binding.progressColor=color

        //init binded variables in xml

        //binding.name = "Serhat"
       // binding.lastname = "Erdem"
